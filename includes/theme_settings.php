...
function getLayoutVariantOptions(): array
{
    return [
        'standard' => 'Standard (horizontale Navigation)',
        'split-panels' => 'Split Panels (linke Seitenleiste, Kacheln)',
        'terminal-rail' => 'Terminal Rail (schmale Seitenleiste, Zeilenlayout)',
        'floating-board' => 'Floating Board (deckartige Karten, zweizeilige Navigation)',
    ];
}
...
function getThemeTemplates(): array
{
    return [
        ...
        'glass_rooftop' => [
            'name' => 'Glass Rooftop',
            'description' => 'Transparente Glasflächen, helle Nebel-Highlights und sanfte Rundungen.',
            'settings' => [
                'brand_font' => 'poppins',
                'brand_font_style' => 'aurora-veil',
                'brand_font_size' => '1.18rem',
                'brand_letter_spacing' => '0.05em',
                'layout_variant' => 'split-panels',
                'radius_lg' => '22px',
                'radius_md' => '14px',
                'shadow_card' => '0 20px 60px rgba(4, 20, 40, 0.45)',
                'shadow_card_light' => '0 16px 40px rgba(120, 220, 255, 0.18)',
                'layout_density' => '0.95',
                'bg1' => '#0b1220',
                'bg2' => '#0f1e33',
                'bg3' => '#070d1a',
                'accent_cyan' => '#7ce7ff',
                'accent_magenta' => '#c4e1ff',
                'accent_purple' => '#9bb9ff',
                'accent_yellow' => '#f2fbff',
                'text_main' => '#e9f4ff',
                'text_muted' => '#bdd7f3',
                'text_main_light' => '#0b1220',
                'text_muted_light' => '#1f2e46',
                'surface' => 'rgba(14, 24, 40, 0.78)',
                'surface_border' => 'rgba(124, 231, 255, 0.35)',
                'light_bg1' => '#f4f9ff',
                'light_bg2' => '#ffffff',
                'header_bg_start' => 'rgba(11,18,32,0.75)',
                'header_bg_end' => 'rgba(17,31,51,0.85)',
                'header_border' => 'rgba(124,231,255,0.32)',
                'header_light_bg' => 'rgba(244,249,255,0.92)',
                'header_light_border' => 'rgba(155,209,255,0.35)',
                'header_light_shadow' => '0 18px 38px rgba(124,231,255,0.28)',
                'header_shadow_base' => '0 14px 34px rgba(0,0,0,0.35)',
            ],
        ],
        'pastel_sorbet' => [
            'name' => 'Pastel Sorbet',
            'description' => 'Helle Sorbet-Farben, luftige Panels und weiche Schatten für ein freundliches UI.',
            'settings' => [
                'brand_font' => 'bungee',
                'brand_font_style' => 'sunset-outline',
                'brand_font_size' => '1.12rem',
                'brand_letter_spacing' => '0.06em',
                'layout_variant' => 'floating-board',
                'radius_lg' => '26px',
                'radius_md' => '18px',
                'shadow_card' => '0 18px 38px rgba(255, 179, 219, 0.25)',
                'shadow_card_light' => '0 14px 30px rgba(255, 214, 165, 0.2)',
                'layout_density' => '0.92',
                'bg1' => '#120d11',
                'bg2' => '#1c1622',
                'bg3' => '#0b0810',
                'accent_cyan' => '#a5f0ff',
                'accent_magenta' => '#ffb3d3',
                'accent_purple' => '#d7b4ff',
                'accent_yellow' => '#ffe0b5',
                'text_main' => '#fff7fb',
                'text_muted' => '#ffd8e8',
                'text_main_light' => '#120d11',
                'text_muted_light' => '#3d2d3c',
                'surface' => 'rgba(23, 17, 27, 0.9)',
                'surface_border' => 'rgba(255, 179, 211, 0.28)',
                'light_bg1' => '#fff7fb',
                'light_bg2' => '#fffcff',
                'header_bg_start' => 'rgba(23,17,27,0.92)',
                'header_bg_end' => 'rgba(28,20,33,0.97)',
                'header_border' => 'rgba(215,180,255,0.3)',
                'header_light_bg' => 'rgba(255,247,251,0.94)',
                'header_light_border' => 'rgba(255,179,211,0.3)',
                'header_light_shadow' => '0 16px 34px rgba(255,179,211,0.24)',
                'header_shadow_base' => '0 12px 30px rgba(0,0,0,0.38)',
            ],
        ],
        'atrium_split' => [
            'name' => 'Atrium Split',
            'description' => 'Linke Glas-Seitenleiste, kachelige Cards und großzügige spacing für Cockpit-Look.',
            'settings' => [
                'brand_font' => 'teko',
                'brand_font_style' => 'laser-grid',
                'brand_font_size' => '1.22rem',
                'brand_letter_spacing' => '0.08em',
                'layout_variant' => 'split-panels',
                'radius_lg' => '24px',
                'radius_md' => '14px',
                'shadow_card' => '0 26px 60px rgba(12, 24, 44, 0.46)',
                'shadow_card_light' => '0 18px 40px rgba(120, 220, 255, 0.2)',
                'layout_density' => '0.9',
                'bg1' => '#070c14',
                'bg2' => '#0d1829',
                'bg3' => '#050a12',
                'accent_cyan' => '#70f0ff',
                'accent_magenta' => '#8ad7ff',
                'accent_purple' => '#6ea0ff',
                'accent_yellow' => '#f3ffe1',
                'text_main' => '#eaf5ff',
                'text_muted' => '#b2c7e6',
                'text_main_light' => '#070c14',
                'text_muted_light' => '#1b2a3e',
                'surface' => 'rgba(12, 24, 44, 0.82)',
                'surface_border' => 'rgba(112, 240, 255, 0.32)',
                'light_bg1' => '#eef6ff',
                'light_bg2' => '#ffffff',
                'header_bg_start' => 'rgba(7,12,20,0.82)',
                'header_bg_end' => 'rgba(13,24,41,0.92)',
                'header_border' => 'rgba(112,240,255,0.28)',
                'header_light_bg' => 'rgba(238,246,255,0.9)',
                'header_light_border' => 'rgba(138,215,255,0.28)',
                'header_light_shadow' => '0 18px 40px rgba(112,240,255,0.22)',
                'header_shadow_base' => '0 16px 32px rgba(0,0,0,0.38)',
            ],
        ],
        'pastel_workdesk' => [
            'name' => 'Pastel Workdesk',
            'description' => 'Deck-artige Karten, zweizeilige Navigation und Pastellflächen wie ein Whiteboard.',
            'settings' => [
                'brand_font' => 'montserrat-sub',
                'brand_font_style' => 'soft-glow',
                'brand_font_size' => '1.14rem',
                'brand_letter_spacing' => '0.05em',
                'layout_variant' => 'floating-board',
                'radius_lg' => '28px',
                'radius_md' => '18px',
                'radius_pill' => '999px',
                'shadow_card' => '0 22px 44px rgba(255, 200, 200, 0.22)',
                'shadow_card_light' => '0 18px 32px rgba(187, 213, 255, 0.18)',
                'layout_density' => '0.88',
                'bg1' => '#0f0a13',
                'bg2' => '#1a1220',
                'bg3' => '#0a0810',
                'accent_cyan' => '#a3e9ff',
                'accent_magenta' => '#ffb8e5',
                'accent_purple' => '#c7c5ff',
                'accent_yellow' => '#ffe7b7',
                'text_main' => '#fff8fd',
                'text_muted' => '#f3dff7',
                'text_main_light' => '#0f0a13',
                'text_muted_light' => '#3c2d3f',
                'surface' => 'rgba(24, 16, 32, 0.92)',
                'surface_border' => 'rgba(255, 184, 229, 0.3)',
                'light_bg1' => '#fff9fd',
                'light_bg2' => '#ffffff',
                'header_bg_start' => 'rgba(26,18,32,0.9)',
                'header_bg_end' => 'rgba(15,10,19,0.92)',
                'header_border' => 'rgba(199,197,255,0.32)',
                'header_light_bg' => 'rgba(255,249,253,0.94)',
                'header_light_border' => 'rgba(255,184,229,0.32)',
                'header_light_shadow' => '0 20px 40px rgba(255,184,229,0.22)',
                'header_shadow_base' => '0 14px 32px rgba(0,0,0,0.42)',
            ],
        ],
    ];
}
...
function normalizeThemeValues(array $values): array
{
    ...
    foreach ($defaults as $key => $default) {
        ...
        if ($key === 'layout_variant' && !array_key_exists($value, getLayoutVariantOptions())) {
            $value = $default;
        }
